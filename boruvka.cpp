...
//pseudocode for boruvka algo

/*Algorithm BoruvkaMST(G)
	A := Ø	
	while A has fewer than n–1 edges do
		for each connected component C in A do
			Let edge e be the smallest-weight edge from C to another component in A.
			if e is not already in A then
				Add edge e to A
	return A
